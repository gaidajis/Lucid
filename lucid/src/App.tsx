...
function App() {
  ...
  const handleEditCard = useCallback((i: LucidItem) => {
    setEditingItem(i);
    setEditModalOpen(true);
  }, []);

  const handleDeleteCard = useCallback((i: LucidItem) => {
    setDeletingItem(i);
    setDeleteModalOpen(true);
  }, []);

  const handleViewCard = useCallback((i: LucidItem) => setViewingItem(i), []);

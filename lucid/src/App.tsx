...
function App() {
  ...
  // Memoize filtering and grouping into a single O(N) pass
  ...
  // Memoize event handlers passed to DataCard to prevent cascading re-renders
  const handleEditItemClick = useCallback((i: LucidItem) => {
    setEditingItem(i);
    setEditModalOpen(true);
  }, []);

  const handleDeleteItemClick = useCallback((i: LucidItem) => {
    setDeletingItem(i);
    setDeleteModalOpen(true);
  }, []);

  const handleViewItemClick = useCallback((i: LucidItem) => {
    setViewingItem(i);
  }, []);

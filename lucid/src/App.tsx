...
function App() {
  ...
  // Filter and group items memoized to prevent recalculation on unrelated renders
  const itemsByTier = useMemo(() => {
    const filtered = items.filter((item: LucidItem) => {
    ...
    // Single pass grouping (O(N) instead of O(N*M))

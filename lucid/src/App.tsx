...
function App() {
  ...
  // Filter items (memoized to prevent recalculation on unrelated state changes like modal opening)
  ...
  // Group items by tier (memoized to prevent recalculation on unrelated state changes)

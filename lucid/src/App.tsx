...
function App() {
  ...
  // Filter items (Memoized to prevent unnecessary re-computations on unrelated state changes like modal toggles)
  ...
  // Group items by tier (Memoized to prevent unnecessary re-computations)

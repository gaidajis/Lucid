...
function App() {
  ...
  // Filter items
  // ⚡ Bolt: Memoize filtered items to prevent unnecessary re-calculations on unrelated state changes (e.g. modals)
  ...
  // Group items by tier
  // ⚡ Bolt: Memoize tier grouping to avoid expensive O(n * tiers) reduction on every render

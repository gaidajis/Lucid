...
function App() {
  ...
  // Filter items
  // ⚡ Bolt: Memoize filtered items to prevent O(N) recalculation on unrelated renders
  ...
  // Group items by tier
  // ⚡ Bolt: Memoize item grouping to prevent O(N) recalculation on unrelated renders

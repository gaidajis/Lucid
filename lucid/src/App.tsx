...
function App() {
  ...
  // Filter items - Memoized to prevent expensive re-calculations on unrelated state changes (like opening modals)
  ...
  // Group items by tier - Memoized to avoid rebuilding the object mapping on every render

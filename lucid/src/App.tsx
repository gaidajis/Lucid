...
function App() {
  ...
  // Filter items
  // Memoize filtered items to avoid recalculation on unrelated state updates (e.g. modal toggles)
  ...
  // Group items by tier
  // Memoize grouped items to avoid expensive array reductions on every render

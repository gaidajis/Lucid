...
function App() {
  ...
  // Filter items
  // ⚡ Bolt: Memoize filtered items to prevent unnecessary re-computations
  // Reduces O(N) filtering operations on unrelated state changes (like toggling modals)
  ...
  // Group items by tier
  // ⚡ Bolt: Memoize tier grouping to avoid O(N*T) grouping on every render

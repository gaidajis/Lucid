...
function App() {
  ...
  // Filter items - Memoized to prevent expensive re-filtering on unrelated state changes (like modal toggles)
  ...
  // Group items by tier - Memoized to prevent expensive re-grouping on unrelated state changes

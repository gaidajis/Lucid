...
function App() {
  ...
  // Memoize filtering and grouping to prevent O(N*M) transformations on unrelated re-renders
  const itemsByTier = useMemo(() => {
    // Pre-populate the map with empty arrays for all tiers

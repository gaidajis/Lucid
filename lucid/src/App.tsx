...
function App() {
  ...
  // Filter and group items by tier
  // ⚡ Bolt: Memoized and combined filtering and grouping into a single O(N) pass
  // instead of O(N * Tiers) sequential filter operations to prevent performance bottlenecks on re-renders.

...
function App() {
  ...
  // Memoize filtering and grouping into a single O(N) pass to prevent unnecessary re-renders
  // and redundant iterations over the items array.
  const itemsByTier = useMemo(() => {
    ...
    for (const item of items) {
      ...
      // If the item passes filters, push it to its corresponding tier group
    ...
    return grouped;
  }, [items, activeFilter.modality, activeFilter.budget, tierIds]);

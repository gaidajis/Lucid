...
function App() {
  ...
  // ⚡ Bolt: Memoize expensive array transformations to prevent O(n) recalculations
  // on every render (e.g. when simply toggling a modal state).
  // Impact: Reduces unnecessary component re-renders and CPU cycles during unrelated state updates.
  ...
  // ⚡ Bolt: Grouping items is an O(n*m) operation. Memoizing this ensures it only
  // recalculates when the filtered items actually change.

  ...
  return (
    <motion.div
      ...
      className={`group relative bg-card-light dark:bg-card border border-border-light dark:border-border rounded-lg overflow-hidden transition-shadow ${
        !editMode ? 'hover:shadow-[0_4px_16px_rgba(0,0,0,0.12)] dark:hover:shadow-[0_4px_16px_rgba(0,0,0,0.4)] cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black dark:focus-visible:ring-white' : ''
      }`}

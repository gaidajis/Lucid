...
export const DataCard: React.FC<DataCardProps> = ({ item, editMode, onEdit, onDelete, onView }) => {
  ...
  return (
    <motion.div
      ...
      className={`group relative bg-card-light dark:bg-card border border-border-light dark:border-border rounded-lg overflow-hidden hover:shadow-[0_4px_16px_rgba(0,0,0,0.12)] dark:hover:shadow-[0_4px_16px_rgba(0,0,0,0.4)] transition-shadow ${!editMode ? 'cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black dark:focus-visible:ring-white' : 'cursor-default'}`}
